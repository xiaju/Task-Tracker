defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{complete: true, desc: "some desc", time: 42, title: "some title"}
  @update_attrs %{complete: false, desc: "some updated desc", time: 43, title: "some updated title"}
  @invalid_attrs %{complete: nil, desc: nil, time: nil, title: nil}
